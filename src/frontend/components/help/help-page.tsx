    ...
    <div style={{ background: COLORS.bg, minHeight: '100%' }}>
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <Paragraph>
            Рейс отменили, поезд ушёл без вас, на сегодня всё раскуплено — а быть на месте надо.
            Обычный поиск в такой ситуации отвечает пустой страницей: на эту дату билетов нет,
            разговор окончен. Мы отвечаем на другой вопрос — не «есть ли билет на сегодня»,
            а «когда ближайшая возможность уехать и что для этого сделать».
          </Paragraph>
        </div>

        <Section title="Что мы делаем">
          <Paragraph>
            Ищем самый ранний выезд, какой вообще возможен. Сначала проверяем ближайшие рейсы
            всеми видами транспорта сразу: поезда, автобусы, самолёты и электрички. Если уехать
            напрямую не выходит, составляем поездку из двух билетов через соседний город —
            например, поездом до крупного узла, дальше автобусом. Оба билета настоящие и
            продаются прямо сейчас.
          </Paragraph>
          <Paragraph>
        ...
        <Section title="Кому это нужно">
          <Paragraph>
            ...
            сегодня, а мест уже нет. Едете в небольшой город, куда прямых рейсов не бывает
            вовсе. Во всех этих случаях важен не сам билет, а ответ на вопрос «когда я смогу
            быть на месте» — и что делать до отъезда.
          </Paragraph>
        </Section>
