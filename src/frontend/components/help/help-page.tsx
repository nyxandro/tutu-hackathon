    ...
    <div style={{ background: COLORS.bg, minHeight: '100%' }}>
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          >
            Нужно уехать, а билетов нет
          </h1>
          <Paragraph>
            Рейс отменили, опоздали на поезд, на сегодня всё раскуплено. А быть на месте надо.
            Обычный поиск в такой ситуации показывает пустую страницу и на этом заканчивает.
            Мы ищем другое. Когда вы реально сможете уехать и что для этого понадобится.
          </Paragraph>
        </div>

        <Section title="Что мы делаем">
          <Paragraph>
            Ищем самый ранний выезд, какой возможен. Сначала смотрим ближайшие рейсы всеми
            видами транспорта сразу, это поезда, автобусы, самолёты и электрички. Если уехать
            напрямую не выходит, составляем поездку из двух билетов через соседний город.
            Например, поездом до крупного узла, дальше автобусом. Оба билета настоящие, их
            можно купить сейчас.
          </Paragraph>
          <Paragraph>
            Стыковки считаем по времени. Учитываем, сколько нужно на пересадку между конкретными
            видами транспорта, и показываем только те варианты, на которые вы успеваете. Ночные
            стыковки тоже собираем. Вечерний рейс с пересадкой под утро часто оказывается самым
        ...
        <Section title="Кому это нужно">
          <Paragraph>
            Отменили рейс и надо срочно найти замену. Опоздали на поезд. Понадобилось выехать
            сегодня, а мест уже нет. Едете в небольшой город, куда прямые рейсы не ходят.
            Во всех этих случаях важен не билет сам по себе, а то, когда вы будете на месте
            и что делать до отъезда.
          </Paragraph>
        </Section>

        <Section title="Как искать">
          <Paragraph>
            Укажите города и дату, при необходимости число пассажиров. Города выбираются из
          ...
          <Paragraph>
            Ниже строки поиска стоят виды транспорта. По умолчанию включены все, выключите
            ненужное. Рядом два условия, про ночную поездку и про тесные пересадки. Они убирают
            из выдачи неудобные варианты.
          </Paragraph>
        </Section>
        ...
        <Section title="Если уехать удастся только завтра">
          <Paragraph>
            Тогда вместе с билетами покажем, где переночевать в городе отправления. Гостиницы
        ...
        <Section title="Откуда данные">
          <Paragraph>
            Все рейсы, цены и гостиницы приходят из сервисов Туту в момент вашего запроса.
            Ничего не выдумано. Если вариант показан, его можно купить. Оплата проходит на
            стороне Туту, мы доводим вас до неё.
          </Paragraph>
        </Section>
